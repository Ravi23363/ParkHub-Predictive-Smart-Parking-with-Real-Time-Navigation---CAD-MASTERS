...
class _ReservationtimeScreenState extends State<ReservationtimeScreen> {
  ...
  final double reservationFee = 1.50;
                  ...
                  onPressed: () {
                    if (selectedDate.isBefore(DateTime.now())) {
                      ...
                      showDialog(
                        context: context,
                        builder: (context) {
                          final upfrontPayment =
                              firstHourPrice + reservationFee;
                          return AlertDialog(
                            title: const Text("Payment Required"),
                            content: Text(
                              "You need to pay RM ${upfrontPayment.toStringAsFixed(2)} upfront for the reservation fee and the first hour. Remaining fees can be settled later.",
                            ),
                            actions: [
                              TextButton(
                                onPressed: () {
